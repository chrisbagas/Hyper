      ...
      <div className="flex flex-col gap-y-3">
        ...
        <ReactMarkdown 
          ...
          components={{
            ...
            h1: ({node, ...props}) => <h1 className="text-neutral-0 text-3xl" {...props} />,
            h2: ({node, ...props}) => <h2 className="text-neutral-0 text-2xl" {...props} />,
            h3: ({node, ...props}) => <h3 className="text-neutral-0 text-xl" {...props} />,
            h4: ({node, ...props}) => <h4 className="text-neutral-0 text-lg" {...props} />,
            h5: ({node, ...props}) => <h5 className="text-neutral-0 text-base" {...props} />,
            h6: ({node, ...props}) => <h6 className="text-neutral-0 text-sm" {...props} />,
            a: ({node, ...props}) => <a className="hover:text-base-5 text-base-4 transition-all" {...props} />,
            ...
            pre: ({node, ...props}) => <pre className="text-neutral-0" {...props} />,
