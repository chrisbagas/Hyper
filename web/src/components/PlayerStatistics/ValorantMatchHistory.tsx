...
export const ValorantMatchHistory: React.FC<ValorantMatchHistoryProps> = ({ match }) => (
    ...
    <div key={match.index}>
        {
            match.victory ? (
                <div className="flex flex-col gap-y-2 lg:gap-y-0 lg:flex-row p-4 bg-base-1 lg:grid lg:grid-cols-3 rounded-md border border-success-main">
                    ...
                    <div className="flex flex-row gap-x-4 items-center">
                        ...
                        <div className="flex flex-row items-center gap-x-2">
                            ...
                            <h1 className="text-2xl font-bold text-success-main">Victory</h1>
                        </div>
                ...
                <div className="flex flex-col gap-y-2 lg:gap-y-0 lg:flex-row p-4 bg-base-1 lg:grid lg:grid-cols-3 rounded-md border border-error-main">
                    ...
                    <div className="flex flex-row gap-x-4 items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="stroke-1 stroke-error-main w-8 h-8">
                            ...
                            <h1 className="text-2xl font-bold text-error-main">Defeat</h1>
                        </div>
